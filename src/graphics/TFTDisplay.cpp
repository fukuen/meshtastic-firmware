...
public:
    ...
    bool init_impl(bool use_reset, bool use_clear)
    {
        ...
        auto id = lgfx::i2c::readRegister8(in_i2c_port, pi4io1_i2c_addr, 0x01).has_value() && lgfx::i2c::readRegister8(in_i2c_port, pi4io2_i2c_addr, 0x01).has_value();
        if (id != 0)
        {
            ...
            static constexpr const uint8_t reg_data_io1_1[] = {
                ...
                0x05,
                0b01000110,
                0, // PI4IO_REG_OUT_SET (bit4=LCD Reset,bit5=GT911 TouchReset  LOW)
                0x07,
                0b00000000,
                0, // PI4IO_REG_OUT_H_IM
                0x0D,
                0b01111111,
                0, // PI4IO_REG_PULL_SEL
                0x0B,
                0b01111111,
                0, // PI4IO_REG_PULL_EN
                0xFF,
            ...
            static constexpr const uint8_t reg_data_io1_2[] = {
                0x05,
                0b01110110,
                0, // PI4IO_REG_OUT_SET (bit4=LCD Reset,bit5=GT911 TouchReset  HIGH)
                0xFF,
                0xFF,
                0xFF,
            };
            ...
            static constexpr const uint8_t reg_data_io2[] = {
                ...
                0x09,
                0b01000000,
                0, // PI4IO_REG_IN_DEF_STA
                0x11,
                0b10111111,
                0, // PI4IO_REG_INT_MASK
                0x05,
                0b10001001,
                0, // PI4IO_REG_OUT_SET
                0xFF,
...

            {
                ...
                if (bus_dsi->init())
                {
                    ...
                    if (hit_ili9881)
                    {
                        ...
                        ESP_LOGD("LGFX", "Panel ILI9881C Found.");
                        _panel_ptr = p;
                    ...
                    else if (hit_st7123)
                    {
                        ...
                        ESP_LOGD("LGFX", "Panel ST7123 Found.");
                        _panel_ptr = p;
